...
// 提交如下代码，可以通过所有测试用例
// 这是一个非常巧妙的解法
// 把形成一个环的一条边特殊处理  假设两个端点是xy
// 那么查询xy两个点之间的距离的时候 可以有三种做法
// 第一种  不考虑特殊边  那么直接树上查询就好了
// 第二种考虑特殊边  假设node1 x 和 node2 y
// 第三种考虑特殊边  假设node1 y 和 node2 x
// 第二种和第三种中肯定有一种是把xy之间树边重复算了
// 我们最终三者取最小值就好了
#include <bits/stdc++.h>
using namespace std;
